function Check-GPPermissions {
    ...
    foreach ($gpo in $DomainGPOs) {
        if ((($gpo.GetSecurityInfo() | Where-Object { $_.Trustee.Name -eq "Authenticated Users" } | Select-Object Permission).Permission -ine "GpoApply") -and
            (($gpo.GetSecurityInfo() | Where-Object { $_.Trustee.Name -eq "Domain Computers" } | Select-Object Permission).Permission -ine "GpoApply")) {
